...
cratesection:addButton("turn off colision",function()for i,v in pairs(workspace.Entities:GetChildren()) do if v.Name == "Crate" then for i,v in pairs(v) do if tostring(v.ClassName) == "Part" then v.CanCollide = false end end end end end)
