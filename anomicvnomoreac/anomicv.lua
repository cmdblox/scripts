...
cratesection:addButton("turn off colision",function() for i,v in pairs(workspace.Entities:GetChildren()) do if v.Name == "Crate" then for i,v in pairs(v:GetChildren()) do if tostring(v.ClassName) == "Part" then v.CanCollide = false v.Color = Color3.fromRGB(50, 62, 168) end end end end end)
...
anomicrp:addButton("Bonfire Clothing",function()game:GetService("ReplicatedStorage")["_CS.Events"].EquipAvatarItem:FireServer("CustomCloth",5700813100) game:GetService("ReplicatedStorage")["_CS.Events"].EquipAvatarItem:FireServer("CustomCloth",5700813650) game:GetService("ReplicatedStorage"):FindFirstChild("_CS.Events").EquipAvatarItem:FireServer("Color",Color3.fromRGB(234, 184, 146),"SkinColor") game:GetService("ReplicatedStorage")["_CS.Events"].EquipAvatarItem:FireServer("Cloth","No Mask") game:GetService("ReplicatedStorage")["_CS.Events"].EquipAvatarItem:FireServer("Cloth","No Glasses") game:GetService("ReplicatedStorage")["_CS.Events"].EquipAvatarItem:FireServer("Cloth","No Beard") game:GetService("ReplicatedStorage")["_CS.Events"].EquipAvatarItem:FireServer("Cloth","No Jewelry") game:GetService("ReplicatedStorage")["_CS.Events"].EquipAvatarItem:FireServer("Cloth","Bald") game:GetService("ReplicatedStorage")["_CS.Events"].EquipAvatarItem:FireServer("Cloth","Modern Cowboy Hat") end)
...
if getCurrentVehicle() ~= nil then
    getCurrentVehicle():SetPrimaryPartCFrame(CFrame.new(372.386292, -0.000833947153, -1320.24548, 0.486186832, 3.79707217e-08, -0.873854876, 4.08698391e-08, 1, 6.61907364e-08, 0.873854876, -6.78953711e-08, 0.486186832) * CFrame.new(0,5,0))
else 
LPlayer.Character.HumanoidRootPart.CFrame = CFrame.new(372.386292, -0.000833947153, -1320.24548, 0.486186832, 3.79707217e-08, -0.873854876, 4.08698391e-08, 1, 6.61907364e-08, 0.873854876, -6.78953711e-08, 0.486186832) end end)
teleSection4:addButton("Player lobby", function()
if getCurrentVehicle() ~= nil then
    getCurrentVehicle():SetPrimaryPartCFrame(CFrame.new(451.888794, -8.47341156, -1337.15466, -0.0644594803, 5.36564535e-08, -0.997920215, 3.67105028e-13, 1, 5.37682183e-08, 0.997920215, 3.46550766e-09, -0.0644594803) * CFrame.new(0,-2,0))
else 
