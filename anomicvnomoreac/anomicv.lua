...
cratesection:addButton("turn off colision",function() for i,v in pairs(workspace.Entities:GetChildren()) do if v.Name == "Crate" then for i,v in pairs(v:GetChildren()) do if tostring(v.ClassName) == "Part" then v.CanCollide = false v.Transparency = 0.7 end end end end end)
