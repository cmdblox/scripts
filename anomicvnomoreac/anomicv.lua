...
anomicrp:addButton("Admin Clothing", function()
    pcall(function()
        game:GetService("ReplicatedStorage")["_CS.Events"].EquipAvatarItem:FireServer("CustomCloth",903971791) game:GetService("ReplicatedStorage")["_CS.Events"].EquipAvatarItem:FireServer("CustomCloth",420309149)
    end)
end)		
--< teleportation
